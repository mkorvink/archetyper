...
```{r testing_with_predictions}
kbl(head(testing_with_predictions), booktabs = T)
...
read_feather(get_versioned_file_name("data_working", "feature_dtl", ".feather")) %>% rename_all(snakecase::to_title_case) %>% kbl(booktabs = T)
